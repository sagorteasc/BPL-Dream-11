...
const Newsletter = () => {
    return (
        <div>
            <div className="bg-[#ad888810] backdrop-blur-md border border-white rounded-3xl p-5 text-center">
                <div style={{ backgroundImage: `url(${bg})` }} className='border-[#13131310] bg-cover bg-center py-20 rounded-3xl backdrop-blur-md'>
                    ...
                    <div className='px-4 md:flex md:gap-2 md:justify-center md:items-center'>
                        <input className='text-[#13131340] text-sm py-4 pl-4 mb-2 rounded-xl bg-transparent border md:mb-0' type="text" placeholder='Enter your email' />
                        <button className='rounded-xl font-bold bg-gradient-to-l from-[#d27eae] to-[#ebbf55] p-4'>Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
